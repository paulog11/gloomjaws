...
import { ModifierCardType, } from '../../common/types.js';
// Standard base modifier deck (20 cards)
export function buildBaseModifierDeck() {
    const cards = [
        // 6× +0
...
function makeCard(type, value, opts = {}) {
 ...
 */
export function drawModifier(deck, discard) {
    const drawn = [];
 ...
 */
export function resolveModifiers(cards, baseAttack) {
